...
public class PhotoDao {
	...
	{
		String sql="select *,substr(fname,1,instr(fname,',')-1) as img, length(fname)-length(replace(fname,',','')) as cnt from photo order by id desc";
		pstmt=conn.prepareStatement(sql);
	 ...
	 //사진이 여러장인 경우 
	public void photo_view(HttpServletRequest request) throws Exception
	{ 
